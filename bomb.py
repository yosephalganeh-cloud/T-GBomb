...
def main():
    ...
    print(f"\n{Y}[*] Starting Attack on {chat_id}... Press Ctrl+C to stop.{W}\n")
    ...
    for i in range(1, total_msgs + 1):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"{R}[!] Rate limited by Telegram. Sleeping for {retry_after} seconds...{W}")
            ...
            # Small delay to prevent immediate ban
            time.sleep(0.5)
            
        except KeyboardInterrupt:
            print(f"\n{R}[!] Stopped by user (Ctrl+C).{W}")
            break
